...
$numberofslides = theme_itb_get_setting('numberofslides');
  ...
  <div id="home-page-carousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
     ...
     <?php for($s1=1;$s1<=$numberofslides;$s1++): 
		...
		$slidecaption = theme_itb_get_setting('slide' . $s1 . 'caption', true);
		$slidedesc = theme_itb_get_setting('slide' . $s1 . 'desc','format_html');
		$slidelink = theme_itb_get_setting('slide' . $s1 . 'link','format_html');
		$slideimg = theme_itb_render_slideimg($s1,'slide' . $s1 . 'image');
      ...
      <div class="item<?php echo $cls_txt2; ?>" style="background-image: url(<?php echo $slideimg; ?>);">
          <div class="carousel-overlay-content">
            <div class="content-wrap">
              ...
              <?php echo $slidedesc; ?><br>
              <a href="<?php echo $slidelink; ?>" class="read-more"><?php echo get_string('readmore','theme_itb'); ?><i class="fa fa-angle-right"></i></a>	
            </div>
          </div>
      </div>
      <?php endfor; ?>
