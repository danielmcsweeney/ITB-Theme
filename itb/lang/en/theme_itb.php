...
/**
 * Strings for component 'theme_academi', language 'en'
 *
...
<img class=img-polaroid src="itb/pix/screenshot.jpg" />
<h3>Theme Credits</h3>
<p>
<h3>Moodle ITB theme</h3>
<p>
...
$string['defaultsidphoneno'] = '(000) 123-999';
...
$string['footerlogo'] = 'Logo for footer';
$string['footerlogodesc'] = 'Please upload your custom footer logo here if you want to add it to the header.
                       <br>The image should be 180px high and any reasonable width (recommended:240px) that suits.';
...
$string['pluginname'] = 'ITB';
$string['readmore'] = 'Read More';
$string['region-side-post'] = 'Right';
$string['region-side-pre'] = 'Left';
$string['sidphoneno'] = 'SID Phone No';
$string['sidemailid'] = 'SID Email';
$string['defaultsidemailid'] = 'sid@itb.ie';
$string['sidphoneno'] = 'SID Phone No';
...
$string['slidelink'] = 'Slide Link (URL)';
$string['slidelinktext'] = 'Enter a URL link for this slide.';
$string['slidelinkdefault'] = 'http://www.itb.ie';
